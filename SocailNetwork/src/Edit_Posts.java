 ...
 * @author taha
 */
public class Edit_Posts extends javax.swing.JFrame {

    /**
     * Creates new form Edit_Posts
     */
    public Edit_Posts() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        EditPost.setBackground(new java.awt.Color(255, 255, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_Posts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edit_Posts().setVisible(true);
            }
        });
    }
